...
const val FILE_NAME = "zh_min_nanwiktionary-20241020-all-titles-in-ns0"

fun main(args: Array<String>) {
    // https://dumps.wikimedia.org/zh_min_nanwiktionary/
    ...
    f.forEachLine {
        if (it.containsPehoeji()) {
            ...
            val rowList = arrayListOf<String>(it, poj, "https://zh-min-nan.wiktionary.org/wiki/$it")
    ...
    writer.writeAll(rowArrayList, "$FILE_NAME-output.csv", append = false)
}
